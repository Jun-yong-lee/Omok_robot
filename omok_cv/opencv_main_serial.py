...
if __name__ == '__main__':
    ...
    while True:
        ...
        # 확인용 카메라
        check2, frame2 = cap2.read()
        img_check_data = frame2.copy()
        roi_img_check_data = img_check_data[200:250, 220:400]
        roi_img_check_data = cv2.resize(roi_img_check_data, (480, 240), interpolation=cv2.INTER_CUBIC)
        cv2.imshow("roi_img_check_data", roi_img_check_data)
